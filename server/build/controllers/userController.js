  ...
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          user = req.session.user, cookies = req.cookies;
...
var kakaoLogin = exports.kakaoLogin = /*#__PURE__*/function () {
  ...
  return function kakaoLogin(_x7, _x8) {
    return _ref4.apply(this, arguments);
  };
}();
var userLogout = exports.userLogout = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    var KAKAO_LOGOUT, data, result;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          KAKAO_LOGOUT = "https://kapi.kakao.com/v1/user/unlink";
          console.log("ACCESS_TOKEN: ", ACCESS_TOKEN);
          _context5.prev = 2;
          _context5.next = 5;
          return fetch(KAKAO_LOGOUT, {
            method: "POST",
            headers: {
              "Content-Type": "application/x-www-form-urlencoded",
              Authorization: "Bearer ".concat(ACCESS_TOKEN)
  ...
  return function userLogout(_x9, _x10) {
